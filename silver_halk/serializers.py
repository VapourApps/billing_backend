...
from .models import Halk_Payment_Request, Halk_Notification


class Halk_Notification_Serializer(ModelSerializer):
	class Meta:
		model = Halk_Notification
		fields = "__all__"


class Halk_Payment_Request_Serializer(ModelSerializer):
	class Meta:
		model = Halk_Payment_Request
		fields = "__all__"


class Halk_Payment_Request_Validation_Serializer(Serializer):
